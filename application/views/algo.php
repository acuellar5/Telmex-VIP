...
<html lang="en">
    ...
    <body data-base="<?= URL::base() ?>">
        <?php $this->load->view('parts/headerF'); ?>
        <br><br>
        <div class="container autoheight p-t-20 m-t-20">
            ...
            <form class= 'well form-horizontal' enctype= 'multipart/form-data'>
                <fieldset>
                    <div class="row">
                        <div class="col col-md-12 botnOtsfiteenDays">
                            <button class="btn btn-danger" id="btnOtsfiteenDays">OTS más de 15 días <span class="badge" id="countBadge">...</span></button>
                        </div>
        ...
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modalEditTicket">Open Modal</button>
            <!-- Modal editar OTs -->
...
<!-- ********************************************************fin formulario plantillas******************************** -->
            ...
            <!-- Modal lista OTs 15 dias -->
             <div id="modalListOtsfiteenDays" class="modal fade" data-backdrop="static"role="dialog" >
                <div class="modal-dialog modal-lg2" style="width: 1000px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                            <h3 class="modal-title" id="myModalLabel">Lista de OTS con más de 15 días</h3>
                        </div>
                        <div class="modal-body">
                            <div>
                                <form class='well form-horizontal' enctype= 'multipart/form-data'>
            ...
            <div id="modalSendMailUpdateReport" class="modal fade" data-backdrop="static" role="dialog" >
                <div class="modal-dialog modal-lg2" style="width: 1000px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        ...
        CUSTOM SCRIPT    
        <?php $this->load->view('parts/footerF'); ?>
